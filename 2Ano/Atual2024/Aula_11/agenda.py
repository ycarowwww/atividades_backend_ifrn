...
class ContactList:
    ...
    def update(self, contact_id: int, new_name: str = "", new_email: str = "", new_number: str = "", new_birthday: datetime = None) -> None:
...
class UI:
    ...
    def insert_contact() -> None:
        ...
        UI.contact_list.append(Contact(UI.current_id, new_name, new_email, new_number, new_birthday))
        UI.current_id += 1
    ...
    def update_contact() -> None:
        ...
        UI.contact_list.update(contact_id, new_name, new_email, new_number, new_birthday)
    ...
    def search_birthmonth() -> None:
        ...
        contacts = UI.contact_list.search_birthmonth(month)
