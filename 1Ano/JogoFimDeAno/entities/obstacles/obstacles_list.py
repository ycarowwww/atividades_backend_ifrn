...
def get_3p_obstacle_list(player_center: tuple[int, int], player_normal_distance: int, player_angular_speed: float, height: int, speed: int, color: tuple[int, int, int]) -> list[Obstacle]: 
    return [
        StationaryObstacle(player_center[0] + player_normal_distance, 0, player_normal_distance * 2, height, speed, 3, color),
        StationaryObstacle(player_center[0] - player_normal_distance, 0, player_normal_distance * 2, height, speed, 3, color),
        StationaryObstacle(player_center[0], 0, player_normal_distance, height, speed, 3, color),
        StationaryObstacle(player_center[0] + player_normal_distance / 2 + 20, 0, player_normal_distance - 20, player_normal_distance * 0.8, speed, 3, color),
        StationaryObstacle(player_center[0] - player_normal_distance / 2 - 20, 0, player_normal_distance - 20, player_normal_distance * 0.8, speed, 3, color),
        InvisibleObstacle(player_center[0] + player_normal_distance, 0, player_normal_distance * 2, height, speed, 3, color),
        InvisibleObstacle(player_center[0] - player_normal_distance, 0, player_normal_distance * 2, height, speed, 3, color)
    ]
